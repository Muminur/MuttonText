...
export const DataTab: React.FC<DataTabProps> = ({ preferences, onChange }) => {
  ...
  return (
    <div className="space-y-6">
      <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100">Data & Backups</h3>
      ...
      <div className="space-y-4">
        <label className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 dark:text-gray-400">Automatically back up your combos</p>
          </div>
        </label>
          ...
          <>
            <div className="space-y-2">
              ...
              <input
                ...
                className="block w-32 rounded border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 px-3 py-2 text-sm focus:border-blue-500 focus:outline-none"
              />
            </div>
